...
export interface Tags extends APP0Tags, APP1Tags, APP12Tags, APP14Tags, APP4Tags, APP6Tags, CompositeTags, EXIFTags, ExifToolTags, FileTags, FlashPixTags, ICC_ProfileTags, IPTCTags, JFIFTags, MPFTags, MakerNotesTags, MetaTags, PanasonicRawTags, PhotoshopTags, PrintIMTags, QuickTimeTags, RAFTags, RIFFTags, XMPTags, ApplicationRecordTags {
    errors?: string[];
    Error?: string;
    Warning?: string;
    SourceFile?: string;
